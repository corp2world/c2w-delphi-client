...
unit CWHashMessageDigest;

interface
{$i CWCompilerDefines.inc}

uses
  CWFIPS, CWGlobal, CWHash, Classes;
...
function TIdHashMessageDigest2.HashToHex(const AHash: TIdBytes): AnsiString;
begin
...
function TIdHashMessageDigest4.HashToHex(const AHash: TIdBytes): AnsiString;
begin
  Result := LongWordHashToHex(AHash, 4);
end;
