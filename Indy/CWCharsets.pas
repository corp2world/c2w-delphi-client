...

{
  ...
  * function FindPreferredCharset(const Charset: TIdCharSet): TIdCharSet;
  ...
  2)
  * function FindCharset(const s: AnsiString): TIdCharset;
  can be used to find a charset from a given AnsiString
...
const
  IdCharsetNames : array[Low(TIdCharSet)..High(TIdCharSet)] of AnsiString = (
    '', {invalid is empty}
...
function FindCharset(const ACharSet: AnsiString): TIdCharset;
function CharsetToCodePage(const ACharSet: TIdCharSet): Word; overload;
function CharsetToCodePage(const ACharSet: AnsiString): Word; overload;
...
{ this is for searching a charset from a AnsiString, it must be case-insensitive }
function FindCharset(const ACharSet: AnsiString): TIdCharset;
var
  Lcset: TIdCharset;
begin
