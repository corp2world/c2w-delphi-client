...
uses
  Classes,
  CWGlobal, CWBaseComponent, CWBuffer, CWException;
...
Begin
  ...
  while Assigned(LIntercept) do begin
    if LIntercept = Self then begin //recursion
      raise EIdInterceptCircularLink.CreateFmt(RSInterceptCircularLink, [ClassName]); // TODO: Resource AnsiString and more english
    end;
