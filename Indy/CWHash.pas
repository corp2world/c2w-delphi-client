...
type
  ...
  protected
    ...
    function HashToHex(const AHash: TIdBytes): AnsiString; virtual; abstract;
    function WordHashToHex(const AHash: TIdBytes; const ACount: Integer): AnsiString;
    function LongWordHashToHex(const AHash: TIdBytes; const ACount: Integer): AnsiString;
  public
    constructor Create; virtual;
    class function IsAvailable : Boolean; virtual;
    function HashString(const ASrc: AnsiString; ADestEncoding: TIdTextEncoding = nil{$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}): TIdBytes;
    function HashStringAsHex(const AStr: AnsiString; ADestEncoding: TIdTextEncoding = nil{$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}): AnsiString;
    function HashBytes(const ASrc: TIdBytes): TIdBytes;
    function HashBytesAsHex(const ASrc: TIdBytes): AnsiString;
    function HashStream(AStream: TStream): TIdBytes; overload;
    function HashStreamAsHex(AStream: TStream): AnsiString; overload;
    function HashStream(AStream: TStream; const AStartPos, ASize: TIdStreamSize): TIdBytes; overload;
    function HashStreamAsHex(AStream: TStream; const AStartPos, ASize: TIdStreamSize): AnsiString; overload;
  end;

  TIdHash16 = class(TIdHash)
  protected
    function GetHashBytes(AStream: TStream; ASize: TIdStreamSize): TIdBytes; override;
    function HashToHex(const AHash: TIdBytes): AnsiString; override;
  public
    function HashValue(const ASrc: AnsiString; ADestEncoding: TIdTextEncoding = nil{$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}): Word; overload;
  ...
  protected
    ...
    function HashToHex(const AHash: TIdBytes): AnsiString; override;
  public
    function HashValue(const ASrc: AnsiString; ADestEncoding: TIdTextEncoding = nil{$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}): LongWord; overload;
...
function TIdHash.HashString(const ASrc: AnsiString; ADestEncoding: TIdTextEncoding = nil
...
function TIdHash.HashStringAsHex(const AStr: AnsiString; ADestEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
begin
...
function TIdHash.HashBytesAsHex(const ASrc: TIdBytes): AnsiString;
begin
...
function TIdHash.HashStreamAsHex(AStream: TStream): AnsiString;
begin
...
function TIdHash.HashStreamAsHex(AStream: TStream; const AStartPos, ASize: TIdStreamSize): AnsiString;
begin
  Result := HashToHex(HashStream(AStream, AStartPos, ASize));
end;

function TIdHash.WordHashToHex(const AHash: TIdBytes; const ACount: Integer): AnsiString;
var
  LValue: Word;
  I: Integer;
begin
...
function TIdHash.LongWordHashToHex(const AHash: TIdBytes; const ACount: Integer): AnsiString;
begin
...
function TIdHash16.HashToHex(const AHash: TIdBytes): AnsiString;
begin
...
function TIdHash16.HashValue(const ASrc: AnsiString; ADestEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
  ): Word;
begin
...
function TIdHash32.HashToHex(const AHash: TIdBytes): AnsiString;
begin
...
function TIdHash32.HashValue(const ASrc: AnsiString; ADestEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
  ): LongWord;
begin
...
begin
  ...
  Result := ACtx.Hash;
  {$ELSE}
  Result := CWFIPS.FinalHashInst(ACtx);
  {$ENDIF}
end;
...
function TIdHashIntf.HashToHex(const AHash: TIdBytes): AnsiString;
begin
  Result := ToHex(AHash);
end;
