...
type
 ...
 DownlevelGetStringScripts_LPFN = function (
     ...
     lpString : LPCWSTR;       // Unicode character input AnsiString
     cchString : Integer;      // size of input AnsiString
     lpScripts : LPWSTR;       // Script list output AnsiString
     cchScripts : Integer      // size of output AnsiString
   ) : Integer stdcall;
  {$EXTERNALSYM DownlevelVerifyScripts_LPFN}
 DownlevelVerifyScripts_LPFN = function (
     dwFlags : DWORD;            // optional behavior flags
     lpLocaleScripts : LPCWSTR;  // Locale list of scripts AnsiString
     cchLocaleScripts : Integer; // size of locale script list AnsiString
     lpTestScripts : LPCWSTR;    // test scripts AnsiString
     cchTestScripts : Integer    // size of test list AnsiString
 ) : BOOL stdcall;
...
function IDNToPunnyCode(const AIDN : TIdUnicodeString) : AnsiString;
function PunnyCodeToIDN(const APunnyCode : AnsiString) : TIdUnicodeString;
