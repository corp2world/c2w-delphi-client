...
}
{
  ...
  of repeated AnsiString operations that were being performed.
  ...
  class function TIdReplyRFC.IsEndMarker(const ALine: AnsiString): Boolean had the
...
type
  ...
  protected
    ...
    function CheckIfCodeIsValid(const ACode: AnsiString): Boolean; override;
    function GetFormattedReply: TStrings; override;
    procedure SetFormattedReply(const AValue: TStrings); override;
  public
    class function IsEndMarker(const ALine: AnsiString): Boolean; override;
  ...
  public
    ...
    constructor CreateError(const AErrorCode: Integer;
     const AReplyMessage: AnsiString); reintroduce; virtual;
    //
...
function TIdReplyRFC.CheckIfCodeIsValid(const ACode: AnsiString): Boolean;
var
  LCode: Integer;
begin
...
class function TIdReplyRFC.IsEndMarker(const ALine: AnsiString): Boolean;
begin
...
constructor EIdReplyRFCError.CreateError(const AErrorCode: Integer;
 const AReplyMessage: AnsiString);
begin
