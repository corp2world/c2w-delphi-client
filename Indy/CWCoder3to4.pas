{
  ...
  input is ALWAYS a AnsiString. Should be a TStream.
...
uses
  CWException, CWResourceStrings, CWStream;
...
begin
  ...
  SetLength(Result, LOutSize); // we know that the AnsiString will grow by 4/3 adjusted to 3 boundary
  LLen := 0;
  LPos := 0;
