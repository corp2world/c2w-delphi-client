...
uses
  Classes,
  CWException, CWExceptionCore, CWAssignedNumbers, CWHeaderList, CWHTTPHeaderInfo, CWReplyRFC,
  CWSSL, CWZLibCompressorBase,
  CWTCPClient, CWURI, CWCookie, CWCookieManager, CWAuthentication, CWAuthenticationManager,
  CWMultipartFormData, CWGlobal, CWBaseComponent, CWUriUtils;
...
type
  ...
  TIdHTTPOnRedirectEvent = procedure(Sender: TObject; var dest: AnsiString; var NumRedirect: Integer; var Handled: boolean; var VMethod: TIdHTTPMethod) of object;
...
type
  ...
  protected
    ...
    procedure SetResponseText(const AValue: AnsiString);
  ...
  public
    ...
    property ResponseText: AnsiString read FResponseText write SetResponseText;
    ...
    //
{
    ...
    procedure DoRequest(const AMethod: TIdHTTPMethod; AURL: AnsiString;
    ...
    function InternalReadLn: AnsiString;
    ...
    function GetResponseCode: Integer;
    function GetResponseText: AnsiString;
    ...
    function DoOnRedirect(var Location: AnsiString; var VMethod: TIdHTTPMethod; RedirectCount: integer): boolean; virtual;
    ...
    //misc internal stuff
    function ResponseCharset: AnsiString;
  public
    destructor Destroy; override;

    procedure Delete(AURL: AnsiString);

    procedure Options(AURL: AnsiString); overload;

    procedure Get(AURL: AnsiString; AResponseContent: TStream); overload;
    procedure Get(AURL: AnsiString; AResponseContent: TStream; AIgnoreReplies: array of SmallInt); overload;
    function Get(AURL: AnsiString
      {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString; overload;
    function Get(AURL: AnsiString; AIgnoreReplies: array of SmallInt
      {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString; overload;

    procedure Trace(AURL: AnsiString; AResponseContent: TStream); overload;
    function Trace(AURL: AnsiString
      {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString; overload;
    procedure Head(AURL: AnsiString);

    function Post(AURL: AnsiString; const ASourceFile: AnsiString
      {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString; overload;
    function Post(AURL: AnsiString; ASource: TStrings; AByteEncoding: TIdTextEncoding = nil
      {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil; ADestEncoding: TIdTextEncoding = nil{$ENDIF}): AnsiString; overload;
    function Post(AURL: AnsiString; ASource: TStream
      {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString; overload;
    function Post(AURL: AnsiString; ASource: TIdMultiPartFormDataStream
      {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString; overload;

    procedure Post(AURL: AnsiString; const ASourceFile: AnsiString; AResponseContent: TStream); overload;
    procedure Post(AURL: AnsiString; ASource: TStrings; AResponseContent: TStream; AByteEncoding: TIdTextEncoding = nil
      {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}); overload;
    procedure Post(AURL: AnsiString; ASource, AResponseContent: TStream); overload;
    procedure Post(AURL: AnsiString; ASource: TIdMultiPartFormDataStream; AResponseContent: TStream); overload;

    function Put(AURL: AnsiString; ASource: TStream
      {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString; overload;
    procedure Put(AURL: AnsiString; ASource, AResponseContent: TStream); overload;
    ...
    property ResponseText: AnsiString read GetResponseText;
  ...
  public
    constructor CreateError(const anErrCode: Integer; const asReplyMessage: AnsiString;
      const asErrorMessage: AnsiString); reintroduce; virtual;
...
uses
  SysUtils,
  CWAllAuthentications, CWComponent, CWCoderMIME, CWTCPConnection,
  CWResourceStringsCore, CWResourceStringsProtocols, CWGlobalProtocols,
  CWIOHandler, CWIOHandlerSocket;

const
  ProtocolVersionString: array[TIdHTTPProtocolVersion] of AnsiString = ('1.0', '1.1'); {do not localize}

{ EIdHTTPProtocolException }

constructor EIdHTTPProtocolException.CreateError(const anErrCode: Integer;
  const asReplyMessage: AnsiString; const asErrorMessage: AnsiString);
begin
...
procedure TIdCustomHTTP.Delete(AURL: AnsiString);
begin
  DoRequest(Id_HTTPMethodDelete, AURL, nil, nil, []);
end;

procedure TIdCustomHTTP.Options(AURL: AnsiString);
begin
  DoRequest(Id_HTTPMethodOptions, AURL, nil, nil, []);
end;

procedure TIdCustomHTTP.Get(AURL: AnsiString; AResponseContent: TStream);
begin
  Get(AURL, AResponseContent, []);
end;

procedure TIdCustomHTTP.Trace(AURL: AnsiString; AResponseContent: TStream);
begin
  DoRequest(Id_HTTPMethodTrace, AURL, nil, AResponseContent, []);
end;

procedure TIdCustomHTTP.Head(AURL: AnsiString);
begin
  DoRequest(Id_HTTPMethodHead, AURL, nil, nil, []);
end;

procedure TIdCustomHTTP.Post(AURL: AnsiString; ASource, AResponseContent: TStream);
var
...
function WWWFormUrlEncode(const ASrc: AnsiString; AByteEncoding: TIdTextEncoding
  {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding{$ENDIF}
  ): AnsiString;
const
  ...
  // the character with a AnsiString formed as follows: Start with the empty AnsiString,
  // and then, taking each byte of the character when expressed in the selected
  // character encoding in turn, append to the AnsiString a U+0025 PERCENT SIGN
...
begin
  ...
  begin
    ...
    begin
      ...
      // encoding, replace the character by a AnsiString consisting of a U+0026 AMPERSAND
...
var
  ...
  function EncodeLineBreaks(AStrings: TStrings): AnsiString;
  begin
...
function TIdCustomHTTP.Post(AURL: AnsiString; const ASourceFile: AnsiString
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
var
...
procedure TIdCustomHTTP.Post(AURL: AnsiString; const ASourceFile: AnsiString; AResponseContent: TStream);
var
  LSource: TStream;
begin
  LSource := TIdReadFileExclusiveStream.Create(ASourceFile);
...
procedure TIdCustomHTTP.Post(AURL: AnsiString; ASource: TStrings; AResponseContent: TStream;
...
function TIdCustomHTTP.Post(AURL: AnsiString; ASource: TStrings; AByteEncoding: TIdTextEncoding = nil
...
function TIdCustomHTTP.Post(AURL: AnsiString; ASource: TStream
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
var
  LResponse: TMemoryStream;
...
procedure TIdCustomHTTP.Put(AURL: AnsiString; ASource, AResponseContent: TStream);
begin
  DoRequest(Id_HTTPMethodPut, AURL, ASource, AResponseContent, []);
end;

function TIdCustomHTTP.Put(AURL: AnsiString; ASource: TStream
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
var
  LResponse: TMemoryStream;
...
function TIdCustomHTTP.Get(AURL: AnsiString
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
begin
...
function TIdCustomHTTP.Trace(AURL: AnsiString
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
var
  LResponse: TMemoryStream;
...
function TIdCustomHTTP.DoOnRedirect(var Location: AnsiString; var VMethod: TIdHTTPMethod; RedirectCount: integer): boolean;
begin
...
function DetectXmlCharset(AStream: TStream): AnsiString;
var
  Buffer: TIdBytes;
...
function TIdCustomHTTP.ResponseCharset: AnsiString;
begin
...
function TIdCustomHTTP.GetResponseText: AnsiString;
begin
...
{
procedure TIdCustomHTTP.SetHost(const Value: AnsiString);
begin
...
procedure TIdCustomHTTP.Post(AURL: AnsiString; ASource: TIdMultiPartFormDataStream;
...
function TIdCustomHTTP.Post(AURL: AnsiString; ASource: TIdMultiPartFormDataStream
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
): AnsiString;
begin
  Assert(ASource<>nil);
...
procedure TIdHTTPResponse.SetResponseText(const AValue: AnsiString);
var
  S: AnsiString;
...
function TIdCustomHTTP.InternalReadLn: AnsiString;
begin
...
function TIdCustomHTTP.Get(AURL: AnsiString; AIgnoreReplies: array of SmallInt
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
var
...
procedure TIdCustomHTTP.DoRequest(const AMethod: TIdHTTPMethod;
  AURL: AnsiString; ASource, AResponseContent: TStream;
  AIgnoreReplies: array of SmallInt);
var
