...
Type
  ...
  public
    ...
    //
    procedure AddServerCookie(const ACookie: AnsiString; AURL: TIdURI);
...
//procedure SplitCookies(const ACookie: AnsiString; ACookies: TStrings);

implementation

uses
  CWAssignedNumbers, CWException, CWGlobal, CWGlobalProtocols, SysUtils;
...
procedure TIdCookieManager.AddServerCookie(const ACookie: AnsiString; AURL: TIdURI);
var
  LCookie: TIdCookie;
begin
