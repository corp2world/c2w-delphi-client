...
uses
  Classes,
  CWGlobal, CWException, CWYarn, CWTask, CWThreadSafe, SysUtils;
...
type
  ...
  public
    constructor Create(ACreateSuspended: Boolean = True;
     ALoop: Boolean = True; const AName: AnsiString = ''); virtual;
...
//BGO:TODO    procedure Synchronize(Method: TMethod); overload;
    ...
    property TerminatingException: AnsiString read FTerminatingException;
...
constructor TIdThread.Create(ACreateSuspended: Boolean; ALoop: Boolean; const AName: AnsiString);
begin
  {$IFDEF DOTNET}
...
constructor TIdThreadWithTask.Create(ATask: TIdTask; const AName: AnsiString);
begin
