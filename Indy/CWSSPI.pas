...
//
// Decide what a AnsiString - 32 bits only since for 16 bits it is clear.
//
...
// internally in security components, an as the AnsiString interface
...
typedef enum
{
    ...
    // AnsiString-ized GUID as returned by IIDFromString().
