...
type
  ...
  protected
    ...
    Fpath: AnsiString;
    FHost: AnsiString;
    FBookmark: AnsiString;
    FUserName: AnsiString;
    FPassword: AnsiString;
    FParams: AnsiString;
    FIPVersion: TIdIPVersion;
    //
    procedure SetURI(const Value: AnsiString);
    function GetURI: AnsiString;
  public
    constructor Create(const AURI: AnsiString = ''); virtual;    {Do not Localize}
    function GetFullURI(const AOptionalFields: TIdURIOptionalFieldsSet = [ofAuthInfo, ofBookmark]): AnsiString;
    function GetPathAndParams: AnsiString;
    class procedure NormalizePath(var APath: AnsiString);
    class function URLDecode(ASrc: AnsiString; AByteEncoding: TIdTextEncoding = nil
      {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString;
    class function URLEncode(const ASrc: AnsiString; AByteEncoding: TIdTextEncoding = nil
      {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString;
    class function ParamsEncode(const ASrc: AnsiString; AByteEncoding: TIdTextEncoding = nil
      {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString;
    class function PathEncode(const ASrc: AnsiString; AByteEncoding: TIdTextEncoding = nil
      {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString;
    //
    property Bookmark : AnsiString read FBookmark write FBookMark;
...
uses
  CWGlobalProtocols, CWResourceStringsProtocols, CWUriUtils,
  SysUtils;

{ TIdURI }

constructor TIdURI.Create(const AURI: AnsiString = '');    {Do not Localize}
begin
  inherited Create;
...
class procedure TIdURI.NormalizePath(var APath: AnsiString);
var
  i: Integer;
begin
...
procedure TIdURI.SetURI(const Value: AnsiString);
var
  LBuffer: AnsiString;
  LTokenPos: Integer;
  LURI: AnsiString;
...
function TIdURI.GetURI: AnsiString;
begin
  FURI := GetFullURI;
...
class function TIdURI.URLDecode(ASrc: AnsiString; AByteEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
var
  i: Integer;
...
class function TIdURI.ParamsEncode(const ASrc: AnsiString; AByteEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
const
...
begin
  ...
  begin
    ...
    begin
      Result := Result + AnsiChar(LChar);
      Inc(I);
    end;
  end;
end;

class function TIdURI.PathEncode(const ASrc: AnsiString; AByteEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
const
...
class function TIdURI.URLEncode(const ASrc: AnsiString; AByteEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
begin
...
function TIdURI.GetFullURI(const AOptionalFields: TIdURIOptionalFieldsSet): AnsiString;
var
  LURI: AnsiString;
begin
...
function TIdURI.GetPathAndParams: AnsiString;
begin
