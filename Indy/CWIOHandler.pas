...

{
  ...
  Added a formatted resource AnsiString for the exception raised in
...
uses
  Classes,
  CWException,
  CWAntiFreezeBase, CWBuffer, CWBaseComponent, CWComponent, CWGlobal, CWExceptionCore,
  CWIntercept, CWResourceStringsCore, CWStream;
...
//TODO:
    ...
    function GetDestination: AnsiString; virtual;
    ...
    procedure PerformCapture(const ADest: TObject; out VLineCount: Integer;
     const ADelim: AnsiString; AUsesDotTransparency: Boolean; AByteEncoding: TIdTextEncoding = nil
     {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
     ); virtual;
    procedure RaiseConnClosedGracefully;
    procedure SetDestination(const AValue: AnsiString); virtual;
    procedure SetHost(const AValue: AnsiString); virtual;
  ...
  public
    ...
    function WaitFor(const AString: AnsiString; ARemoveFromBuffer: Boolean = True;
    ...
    procedure Write(const AOut: AnsiString; AByteEncoding: TIdTextEncoding = nil
      {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
      ); overload; virtual;
    procedure WriteLn(AEncoding: TIdTextEncoding = nil); overload;
    procedure WriteLn(const AOut: AnsiString; AByteEncoding: TIdTextEncoding = nil
      {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
      ); overload; virtual;
    procedure WriteLnRFC(const AOut: AnsiString = ''; AByteEncoding: TIdTextEncoding = nil
      {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
      ); virtual;
    ...
    function WriteFile(const AFile: AnsiString; AEnableTransferFile: Boolean = False): Int64; virtual;
    //
    // Read methods
    //
    ...
    function InputLn(const AMask: AnsiString = ''; AEcho: Boolean = True;
    ...
    procedure Capture(ADest: TStream; ADelim: AnsiString;
    ...
    procedure Capture(ADest: TStream; out VLineCount: Integer;
      const ADelim: AnsiString = '.'; AUsesDotTransparency: Boolean = True;
      AByteEncoding: TIdTextEncoding = nil
      {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
      ); overload;
    ...
    procedure Capture(ADest: TStrings; const ADelim: AnsiString;
      AUsesDotTransparency: Boolean = True; AByteEncoding: TIdTextEncoding = nil
      {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
      ); overload;
    ...
    function ReadLn(AByteEncoding: TIdTextEncoding = nil
      {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString; overload; // .Net overload
    function ReadLn(ATerminator: AnsiString; AByteEncoding: TIdTextEncoding
      {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString; overload;
    function ReadLn(ATerminator: AnsiString; ATimeout: Integer = IdTimeoutDefault;
    ...
    function ReadLnRFC(var VMsgEnd: Boolean; const ALineTerminator: AnsiString;
      const ADelim: AnsiString = '.'; AByteEncoding: TIdTextEncoding = nil
      {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
      ): AnsiString; overload;
    ...
    function ReadLnSplit(var AWasSplit: Boolean; ATerminator: AnsiString = LF;
...
uses
  ...
  Macapi.CoreServices,
    {$ENDIF}
  {$ENDIF}
  CWStack, CWStackConsts, CWResourceStrings, SysUtils;
...
function TIdIOHandler.GetDestination: AnsiString;
begin
  Result := FDestination;
end;

procedure TIdIOHandler.SetDestination(const AValue: AnsiString);
begin
  FDestination := AValue;
end;
...
procedure TIdIOHandler.Write(const AOut: AnsiString; AByteEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
  );
begin
  if AOut <> '' then begin
...
function TIdIOHandler.ReadLn(ATerminator: AnsiString; AByteEncoding: TIdTextEncoding
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
{$IFDEF USE_CLASSINLINE}inline;{$ENDIF}
begin
...
function TIdIOHandler.ReadLn(ATerminator: AnsiString; ATimeout: Integer = IdTimeoutDefault;
  AMaxLineLength: Integer = -1; AByteEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
var
...
begin
  ...
  IMPORTANT!!!
   ...
   AnsiString is shorter then the original buffer position.
...
function TIdIOHandler.ReadLnRFC(var VMsgEnd: Boolean; const ALineTerminator: AnsiString;
  const ADelim: AnsiString = '.'; AByteEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
begin
...
function TIdIOHandler.ReadLnSplit(var AWasSplit: Boolean; ATerminator: AnsiString = LF;
  ATimeout: Integer = IdTimeoutDefault; AMaxLineLength: Integer = -1;
  AByteEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
...
procedure TIdIOHandler.WriteLn(const AOut: AnsiString;
  AByteEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
  );
begin
...
procedure TIdIOHandler.WriteLnRFC(const AOut: AnsiString = '';
  AByteEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ASrcEncoding: TIdTextEncoding = nil{$ENDIF}
  );
begin
...
procedure TIdIOHandler.SetHost(const AValue: AnsiString);
begin
  FHost := AValue;
end;
...
begin
  ...
  try
    ...
    repeat
      ...
      //DONE -oAPR: Dont use a AnsiString, use a memory buffer or better yet the buffer itself.
      try
        try
...
procedure TIdIOHandler.PerformCapture(const ADest: TObject;
  out VLineCount: Integer; const ADelim: AnsiString;
...
function TIdIOHandler.InputLn(const AMask: AnsiString = ''; AEcho: Boolean = True;
  ATabWidth: Integer = 8; AMaxLineLength: Integer = -1;
  AByteEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; AAnsiEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
...
function TIdIOHandler.WaitFor(const AString: AnsiString; ARemoveFromBuffer: Boolean = True;
  AInclusive: Boolean = False; AByteEncoding: TIdTextEncoding = nil;
  ATimeout: Integer = IdTimeoutDefault
  {$IFDEF STRING_IS_ANSI}; AAnsiEncoding: TIdTextEncoding = nil{$ENDIF}
  ): AnsiString;
...
procedure TIdIOHandler.Capture(ADest: TStream; ADelim: AnsiString;
  AUsesDotTransparency: Boolean = True; AByteEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
  );
var
...
procedure TIdIOHandler.Capture(ADest: TStrings; const ADelim: AnsiString;
  AUsesDotTransparency: Boolean = True; AByteEncoding: TIdTextEncoding = nil
  {$IFDEF STRING_IS_ANSI}; ADestEncoding: TIdTextEncoding = nil{$ENDIF}
  );
var
...
function TIdIOHandler.WriteFile(const AFile: AnsiString; AEnableTransferFile: Boolean): Int64;
var
