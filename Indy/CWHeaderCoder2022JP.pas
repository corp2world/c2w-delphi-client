...
class function TIdHeaderCoder2022JP.Decode(const ACharSet: AnsiString; const AData: TIdBytes): AnsiString;
var
  T : AnsiString;
  I, L : Integer;
  isK : Boolean;
...
class function TIdHeaderCoder2022JP.Encode(const ACharSet, AData: AnsiString): TIdBytes;
const
...
class function TIdHeaderCoder2022JP.CanHandle(const ACharSet: AnsiString): Boolean;
begin
