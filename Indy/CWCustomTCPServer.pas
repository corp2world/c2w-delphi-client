...
uses
  Classes,
  CWBaseComponent,
  CWComponent, CWContext, CWGlobal, CWException,
  CWIntercept, CWIOHandler, CWIOHandlerStack,
  CWReply, CWScheduler, CWSchedulerOfThread, CWServerIOHandler,
  CWServerIOHandlerStack, CWSocketHandle, CWStackConsts, CWTCPConnection,
  CWThread, CWYarn, SysUtils;
...
uses
  ...
  {$ENDIF}
  CWGlobalCore,
  CWResourceStringsCore, CWReplyRFC,
  CWSchedulerOfThreadDefault, CWStack,
  CWThreadSafe;
...
procedure AssertClassName(const ABool : Boolean; const AString : AnsiString); inline;
begin
