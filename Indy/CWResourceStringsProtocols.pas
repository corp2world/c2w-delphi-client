...
unit CWResourceStringsProtocols;
...
resourcestring
  ...
  RSIMAP4NumberInvalidString = 'Number parameter (relative message number or UID) is invalid; Cannot contain an empty AnsiString.';
  ...
  RSIMAP4UTFIllegalBitShifting = 'Illegal bit shifting in MUTF7 AnsiString';
  ...
  { Network Calculator }
  RSNETCALInvalidIPString     = 'The AnsiString %s does not translate into a valid IP.';
  ...
  RSIllegalCharInInputString = 'Illegal character in input AnsiString.';
  ...
  RSMFDInvalidTransfer          = 'Unsupported transfer type. You can assign only an empty AnsiString or one of the following values: 7bit, 8bit, binary, quoted-printable, base64.';
  ...
  ///IdPOP3Reply
  //user's provided reply will follow this AnsiString
  RSPOP3ReplyInvalidEnhancedCode = 'Invalid Enhanced Code: ';

  //IdSMTPReply
  RSSMTPReplyInvalidReplyStr = 'Invalid Reply AnsiString.';
