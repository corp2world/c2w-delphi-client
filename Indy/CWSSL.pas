...
type
  ...
  protected
    ...
    procedure SetURIToCheck(const AValue: AnsiString); virtual;
  public
...
matches the identity information present in the server certificate.
    ...
    property URIToCheck : AnsiString read FURIToCheck write SetURIToCheck;
  end;
...
type
  ...
  public
    ...
    property Vendor : AnsiString read FVendor write FVendor;
...
procedure TIdSSLIOHandlerSocketBase.SetURIToCheck(const AValue: AnsiString);
begin
  FURIToCheck := AValue;
end;
