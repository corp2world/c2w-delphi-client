...
}
{
  ...
  Changed Content-type default in TIdEntityHeaderInfo back to empty AnsiString
...
type
  ...
  protected
    ...
    FContentRangeUnits: AnsiString;
    FContentType: AnsiString;
    FContentVersion: AnsiString;
    ...
    procedure SetContentType(const AValue: AnsiString);
  ...
  published
    property CacheControl: AnsiString read FCacheControl write FCacheControl;
    property CharSet: AnsiString read FCharSet write FCharSet;
    property Connection: AnsiString read FConnection write FConnection;
    property ContentDisposition: AnsiString read FContentDisposition write FContentDisposition;
    ...
    property ContentRangeUnits: AnsiString read FContentRangeUnits write FContentRangeUnits;
    property ContentType: AnsiString read FContentType write SetContentType;
    property ContentVersion: AnsiString read FContentVersion write FContentVersion;
    property CustomHeaders: TIdHeaderList read FCustomHeaders write SetCustomHeaders;
    property Date: TDateTime read FDate write FDate;
    property ETag: AnsiString read FETag write FETag;
    property Expires: TDateTime read FExpires write FExpires;
    property LastModified: TDateTime read FLastModified write FLastModified;
    property Pragma: AnsiString read FPragma write FPragma;
    property TransferEncoding: AnsiString read FTransferEncoding write FTransferEncoding;
  end;
  ...
  published
    ...
    property ProxyPassword: AnsiString read FPassword write FPassword;
    property ProxyPort: Integer read FPort write SetProxyPort;
    property ProxyServer: AnsiString read FServer write SetProxyServer;
    property ProxyUsername: AnsiString read FUsername write FUserName;
  end;
  ...
  protected
    ...
    function GetText: AnsiString;
    procedure SetText(const AValue: AnsiString);
    procedure SetUnits(const AValue: AnsiString);
  public
  ...
  public
    ...
    property Authentication: TIdAuthentication read FAuthentication write FAuthentication;
  published
    property Accept: AnsiString read FAccept write FAccept;
    property AcceptCharSet: AnsiString read FAcceptCharSet write FAcceptCharSet;
    property AcceptEncoding: AnsiString read FAcceptEncoding write FAcceptEncoding;
    property AcceptLanguage: AnsiString read FAcceptLanguage write FAcceptLanguage;
    property BasicAuthentication: boolean read FBasicByDefault write FBasicByDefault;
    property Host: AnsiString read FHost write FHost;
    property From: AnsiString read FFrom write FFrom;
    property Password: AnsiString read FPassword write FPassword;
    property Referer: AnsiString read FReferer write FReferer;
    property UserAgent: AnsiString read FUserAgent write FUserAgent;
    property Username: AnsiString read FUsername write FUsername;
    property ProxyConnection: AnsiString read FProxyConnection write FProxyConnection;
    property Range: AnsiString read GetRange write SetRange; //deprecated 'Use Ranges property';
    property Ranges: TIdEntityRanges read FRanges write SetRanges;
    property MethodOverride: AnsiString read FMethodOverride write FMethodOverride;
  end;
  ...
  protected
    ...
    procedure SetAcceptRanges(const Value: AnsiString);
    procedure ProcessHeaders; override;
    procedure SetHeaders; override;
  public
    ...
    destructor Destroy; override;
  published
    property AcceptRanges: AnsiString read FAcceptRanges write SetAcceptRanges;
...
procedure TIdEntityHeaderInfo.SetContentType(const AValue: AnsiString);
var
  S, LCharSet: AnsiString;
  LComp: TComponent;
begin
...
procedure TIdProxyConnectionInfo.SetProxyServer(const Value: AnsiString);
begin
...
function TIdEntityRange.GetText: AnsiString;
begin
...
procedure TIdEntityRange.SetText(const AValue: AnsiString);
var
  LValue, S: AnsiString;
begin
  LValue := Trim(AValue);
...
function TIdEntityRanges.GetText: AnsiString;
var
  I: Integer;
  S: AnsiString;
begin
...
procedure TIdEntityRanges.SetText(const AValue: AnsiString);
var
  LUnits, LTmp: AnsiString;
  LRanges: TStringList;
  I: Integer;
...
procedure TIdEntityRanges.SetUnits(const AValue: AnsiString);
var
  LUnits: AnsiString;
begin
  LUnits := Trim(AValue);
...
function TIdRequestHeaderInfo.GetRange: AnsiString;
begin
  Result := FRanges.Text;
end;

procedure TIdRequestHeaderInfo.SetRange(const AValue: AnsiString);
begin
  FRanges.Text := AValue;
end;
...
procedure TIdResponseHeaderInfo.SetAcceptRanges(const Value: AnsiString);
begin
  FAcceptRanges := Value;
end;
