...
}
{
  ...
  Corrected spelling error in resource AnsiString name.
  Added resource AnsiString for circular links exception in transparent proxy.
...
type
  ...
  protected
    ...
    procedure MakeConnection(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION); virtual; abstract;
    procedure Notification(AComponent: TComponent; Operation: TOperation); override;
    procedure SetChainedProxy(const AValue: TIdCustomTransparentProxy);
  public
    procedure Assign(ASource: TPersistent); override;
    procedure OpenUDP(AHandle : TIdSocketHandle; const AHost: AnsiString = ''; const APort: TIdPort = 0; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION); virtual;
    ...
    procedure SendToUDP(AHandle: TIdSocketHandle;
      const AHost: AnsiString; const APort: TIdPort; const AIPVersion: TIdIPVersion;
      const ABuffer : TIdBytes); virtual;
    procedure Connect(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION);
    //
    procedure Bind(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION);overload;virtual;
...
uses
  CWResourceStringsCore, CWExceptionCore;
...
procedure TIdCustomTransparentProxy.Connect(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION);
begin
...
procedure TIdCustomTransparentProxy.Bind(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION);
begin
  raise EIdTransparentProxyCantBind.Create(RSTransparentProxyCannotBind);
end;
...
procedure TIdCustomTransparentProxy.OpenUDP(AHandle: TIdSocketHandle;
  const AHost: AnsiString = ''; const APort: TIdPort = 0;
