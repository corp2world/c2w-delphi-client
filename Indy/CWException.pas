...
type
  ...
  public
    ...
    constructor Create(const AMsg: AnsiString); overload; virtual;
    class procedure Toss(const AMsg: AnsiString);
  end;
...
constructor EIdException.Create(const AMsg : AnsiString);
begin
  inherited Create(AMsg);
end;

class procedure EIdException.Toss(const AMsg: AnsiString);
begin
  raise Create(AMsg);
end;
