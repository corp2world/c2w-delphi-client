...
type
  ...
  protected
    ...
    function GetDestination: AnsiString; override;
    procedure SetDestination(const AValue: AnsiString); override;
  ...
  public
    ...
    function WriteFile(const AFile: AnsiString; AEnableTransferFile: Boolean = False): Int64; override;
    //
  ...
  published
    property BoundIP: AnsiString read FBoundIP write FBoundIP;
...
function TIdIOHandlerSocket.GetDestination: AnsiString;
begin
  Result := Host;
...
procedure TIdIOHandlerSocket.SetDestination(const AValue: AnsiString);
var
  LPortStart: integer;
begin
...
function TIdIOHandlerSocket.WriteFile(const AFile: AnsiString;
