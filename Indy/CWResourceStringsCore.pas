...
}
{
  ...
  EIdMaxCaptureLineExceeded message AnsiString

  Rev 1.0    2004.02.03 4:19:50 PM  czhower
  Rename

  Rev 1.15    10/24/2003 4:21:56 PM  DSiders
  Addes resource AnsiString for stream read exception.
  ...
  Added resource AnsiString for circular links from transparent proxy.
  ...
  Added resource AnsiString for exception raised in TIdSchedulerOfThread.NewYarn.
  ...
  Exceptions for scheduler AnsiString.

  Rev 1.0    11/13/2002 08:42:02 AM  JPMugaas
}

unit CWResourceStringsCore;
