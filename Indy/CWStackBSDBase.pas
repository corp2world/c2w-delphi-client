...
uses
  Classes,
  CWException, CWStack, CWStackConsts, CWGlobal;
...
//procedure EmptyIPRec(var VIP : TIdIPAddress);
  ...
  protected
    ...
    procedure MembershipSockOpt(AHandle: TIdStackSocketHandle;
      const AGroupIP, ALocalIP : AnsiString; const ASockOpt : Integer;
  ...
  public
    ...
    function ReceiveFrom(ASocket: TIdStackSocketHandle; var VBuffer: TIdBytes;
      var VIP: AnsiString; var VPort: TIdPort; var VIPVersion: TIdIPVersion): Integer; override;
    ...
    function TranslateTInAddrToString(var AInAddr; const AIPVersion: TIdIPVersion): AnsiString;
    procedure TranslateStringToTInAddr(const AIP: AnsiString; var AInAddr; const AIPVersion: TIdIPVersion);
    function WSGetServByName(const AServiceName: AnsiString): TIdPort; virtual; abstract;
//    function WSGetServByPort(const APortNumber: TIdPort): TStrings; virtual; {$IFDEF HAS_DEPRECATED}deprecated{$IFDEF HAS_DEPRECATED_MSG} 'Use AddServByPortToList()'{$ENDIF};{$ENDIF}
    ...
    procedure WSSendTo(ASocket: TIdStackSocketHandle; const ABuffer;
      const ABufferLength, AFlags: Integer; const AIP: AnsiString; const APort: TIdPort;
    ...
    procedure DropMulticastMembership(AHandle: TIdStackSocketHandle;
      const AGroupIP, ALocalIP : AnsiString;
      const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION); override;
...
function TIdStackBSDBase.TranslateTInAddrToString(var AInAddr;
  const AIPVersion: TIdIPVersion): AnsiString;
var
  i: Integer;
begin
  case AIPVersion of
...
procedure TIdStackBSDBase.TranslateStringToTInAddr(const AIP: AnsiString;
...
function TIdStackBSDBase.ReceiveFrom(ASocket: TIdStackSocketHandle;
  var VBuffer: TIdBytes; var VIP: AnsiString; var VPort: TIdPort;
...
procedure TIdStackBSDBase.DropMulticastMembership(AHandle: TIdStackSocketHandle;
  const AGroupIP, ALocalIP : AnsiString; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION);
begin
