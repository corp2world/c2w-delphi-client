...
Type
  ...
  protected
    ...
    FHost, FDomain, FUser: AnsiString;
...
function TIdNTLMAuthentication.Authentication: AnsiString;
var
  buf: TIdBytes;
...
procedure TIdNTLMAuthentication.SetUserName(const Value: AnsiString);
begin
