...
uses
  Classes,
  CWGlobal, CWSocketHandle, CWIOHandlerSocket, CWExceptionCore, CWStack,
  SysUtils;
...
uses
  ...
  Posix.SysTime,
  {$ENDIF}
  CWAntiFreezeBase, CWResourceStringsCore, CWResourceStrings, CWStackConsts, CWException,
  CWTCPConnection, CWComponent, CWIOHandler;
...
begin
  ...
  //so we don't do a AnsiString conversion in Binding.PeerIP.
  if Assigned(OnStatus) then begin
