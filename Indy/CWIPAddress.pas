...
}
{
  ...
  Added a property for returning the IP address as a AnsiString which works for
...
type
  ...
  protected
    ...
    //property as AnsiString Get methods
    function GetIPv4AsString : AnsiString;
    function GetIPv6AsString : AnsiString;
  ...
  public
    ...
    class function MakeAddressObject(const AIP : AnsiString) : TIdIPAddress; overload;
    class function MakeAddressObject(const AIP : AnsiString; const AIPVersion: TIdIPVersion) : TIdIPAddress; overload;
    function CompareAddress(const AIP : AnsiString; var VErr : Boolean) : Integer;
    function HToNBytes: TIdBytes;

    property IPv4 : Cardinal read FIPv4 write FIPv4;
    property IPv4AsString : AnsiString read GetIPv4AsString;
    property IPv6AsString : AnsiString read GetIPv6AsString;
    property AddrType : TIdIPVersion read FAddrType write FAddrType;
    property IPAsString : AnsiString read GetIPAddress;
  end;
...
function TIdIPAddress.CompareAddress(const AIP: AnsiString; var VErr: Boolean): Integer;
var
  LIP2 : TIdIPAddress;
  i : Integer;
{
...
function TIdIPAddress.GetIPAddress: AnsiString;
begin
  if FAddrType = Id_IPv4 then begin
...
function TIdIPAddress.GetIPv4AsString: AnsiString;
begin
  if FAddrType = Id_IPv4 then begin
...
function TIdIPAddress.GetIPv6AsString: AnsiString;
var
  I: Integer;
begin
...
class function TIdIPAddress.MakeAddressObject(const AIP: AnsiString): TIdIPAddress;
var
  LErr : Boolean;
begin
...
class function TIdIPAddress.MakeAddressObject(const AIP: AnsiString; const AIPVersion: TIdIPVersion): TIdIPAddress;
var
  LErr : Boolean;
begin
  Result := TIdIPAddress.Create;
