...
uses
  Classes,
  CWAssignedNumbers, CWException, CWBaseComponent,
  CWComponent, CWCustomTransparentProxy, CWGlobal, CWIOHandler,
  CWIOHandlerSocket, CWSocketHandle;
...
type
  ...
  protected
    ...
    function DisasmUDPReplyPacket(const APacket : TIdBytes;
      var VHost : AnsiString; var VPort : TIdPort; var VIPVersion: TIdIPVersion): TIdBytes;
    function MakeUDPRequestPacket(const AData: TIdBytes;
      const AHost: AnsiString; const APort: TIdPort) : TIdBytes;
    ...
    procedure MakeSocks4Request(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort; const ARequest : Byte);
    procedure MakeSocks5Request(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort; const ARequest : Byte; var VBuf : TIdBytes; var VLen : Integer);
    procedure MakeSocks4Connection(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort);
    procedure MakeSocks4Bind(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort);
    procedure MakeSocks5Connection(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION);
    procedure MakeSocks5Bind(AIOHandler: TIdIOHandler; const AHost: AnsiString;
      const APort: TIdPort; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION);
    procedure MakeConnection(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION); override;
  ...
  public
    ...
    procedure Bind(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION); override;
    function  Listen(AIOHandler: TIdIOHandler; const ATimeOut:integer):boolean;override;
    procedure OpenUDP(AHandle : TIdSocketHandle; const AHost: AnsiString = ''; const APort: TIdPort = 0; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION); override;
    function RecvFromUDP(AHandle: TIdSocketHandle; var ABuffer : TIdBytes;
      var VPeerIP: AnsiString; var VPeerPort: TIdPort; var VIPVersion: TIdIPVersion;
      AMSec: Integer = IdTimeoutDefault): Integer; override;
    procedure SendToUDP(AHandle: TIdSocketHandle; const AHost: AnsiString;
...
uses
   CWResourceStringsCore, CWExceptionCore, CWIPAddress, CWStack,
  CWTCPClient,
  CWIOHandlerStack, SysUtils;
...
procedure TIdSocksInfo.MakeSocks4Request(AIOHandler: TIdIOHandler; const AHost: AnsiString;
...
procedure TIdSocksInfo.MakeSocks4Connection(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort);
var
  LResponse: TIdBytes;
begin
...
procedure TIdSocksInfo.MakeSocks5Request(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort; const ARequest : Byte; var VBuf : TIdBytes; var VLen : Integer);
var
  LIP : TIdIPAddress;
  LAddr: TIdBytes;
begin
...
procedure TIdSocksInfo.MakeSocks5Connection(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION);
var
  Lpos: Integer;
  LBuf: TIdBytes;
begin
...
procedure TIdSocksInfo.MakeSocks4Bind(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort);
var
  LResponse: TIdBytes;
...
procedure TIdSocksInfo.MakeConnection(AIOHandler: TIdIOHandler; const AHost: AnsiString; const APort: TIdPort; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION);
begin
  case Version of
...
procedure TIdSocksInfo.MakeSocks5Bind(AIOHandler: TIdIOHandler; const AHost: AnsiString;
  const APort: TIdPort; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION);
var
  Lpos: Integer;
  LBuf: TIdBytes;
...
procedure TIdSocksInfo.Bind(AIOHandler: TIdIOHandler; const AHost: AnsiString;
  const APort: TIdPort; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION);
begin
  case Version of
...
procedure TIdSocksInfo.OpenUDP(AHandle: TIdSocketHandle;
  const AHost: AnsiString=''; const APort: TIdPort=0; const AIPVersion: TIdIPVersion = ID_DEFAULT_IP_VERSION);
begin
  case Version of
    svSocks4, svSocks4A: raise EIdSocksUDPNotSupportedBySOCKSVersion.Create(RSSocksUDPNotSupported);
...
function TIdSocksInfo.RecvFromUDP(AHandle: TIdSocketHandle;
  var ABuffer : TIdBytes; var VPeerIP: AnsiString; var VPeerPort: TIdPort;
...
procedure TIdSocksInfo.SendToUDP(AHandle: TIdSocketHandle; const AHost: AnsiString;
