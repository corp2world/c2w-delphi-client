...
type
  ...
  protected
    function GetIndyVersion: AnsiString;
  ...
  public
    ...
    {$ENDIF}
    property Version: AnsiString read GetIndyVersion;
  published
  end;
...
function TIdBaseComponent.GetIndyVersion: AnsiString;
begin
  Result := gsIdVersion;
end;
