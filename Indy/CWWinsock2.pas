...
uses
  CWException, CWGlobal, SysUtils, Windows;

type
  EIdWinsockStubError = class(EIdException)
  protected
    FWin32Error : DWORD;
    FWin32ErrorMessage : AnsiString;
    FTitle : AnsiString;
  public
    constructor Build(AWin32Error: DWORD; const ATitle: AnsiString; AArgs: array of const);
    property Win32Error : DWORD read FWin32Error;
    property Win32ErrorMessage : AnsiString read FWin32ErrorMessage;
...
const
  ...
  AI_NUMERICHOST        = $00000004;   // Nodename must be a numeric address AnsiString
...
constructor EIdWinsockStubError.Build(AWin32Error: DWORD; const ATitle: AnsiString; AArgs: array of const);
begin
...
function FixupStubEx(hSocket: TSocket; const AName: AnsiString; const AGuid: TGUID): Pointer;
var
  LStatus: LongInt;
  LBytesSend: DWORD;
begin
